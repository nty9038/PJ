...
<p><br></p>
<p><br></p>
<div class="hr-sect">부평</div>
<br>

<div class="theater" style="padding: 0px 500px  0px 500px ;">
	<!--부평-->	
	<div>
	<img src="..\images\bu.JPG" alt="No Image" width="900" height="400" >
	</div>
	
	<br>
	<p class="con">인천 부평구 마장로 489 아이즈빌아울렛</p>
	
	<a href="https://map.naver.com/v5/entry/place/12267356?c=14097146.7410935,4512107.4544731,11,0,0,0,dh" target="_blank" 
	style="font-family: 'Noto Sans KR', sans-serif; font-size: 15px;">[위치보기]</a>
	<br><br>
	
	<p class="con">1544-8855<br>
	1관 / 15석</p>
