...
<div style="float: left;">
                ...
                <li class="main">
                 전라
                  <ul class="sub" style="display:none">
                  <li><a href="${path}/theater/theater8.do">군산</a></li>
                     <li>|  나주  |  목포  |  순천</li>
   				 </ul>
                </li>
                </ul>
...
<p><br></p>
<p><br></p>
<div class="hr-sect">군산</div>
<br>

<div class="theater" style="padding: 0px 500px  0px 500px ;">
	<!--군산-->	
	<div>
	<img src="..\images\gun.JPG" alt="No Image" width="900" height="400" >
	</div>
	
	<br>
	<p class="con">전라북도 군산시 나운동 백토로 198</p>
	
	<a href="https://map.naver.com/v5/entry/place/13009149?c=14103845.7699382,4295716.6687782,15,0,0,0,dh" target="_blank" 
	style="font-family: 'Noto Sans KR', sans-serif; font-size: 15px;">[위치보기]</a>
	<br><br>
	
	<p class="con">1544-5885<br>
	1관 / 15석</p>
