...
<p><br></p>
<p><br></p>
<div class="hr-sect">김해</div>
<br>

<div class="theater" style="padding: 0px 500px  0px 500px ;">
	<!--김해-->	
	<div>
	<img src="..\images\kim.JPG" alt="No Image" width="900" height="400" >
	</div>
	
	<br>
	<p class="con">경상남도 김해시 내외중앙로 137</p>
	
	<a href="https://map.naver.com/v5/entry/place/12144061?c=14345121.1482286,4196840.8322499,15,0,0,0,dh" target="_blank" 
	style="font-family: 'Noto Sans KR', sans-serif; font-size: 15px;">[위치보기]</a>
	<br><br>
	
	<p class="con">1544-8852<br>
	1관 / 25석</p>
